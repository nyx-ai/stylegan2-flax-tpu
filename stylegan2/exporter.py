...
"""
Modified generator/discriminator used to get intermediate values.
TODO This is a very hacky way of doing things, find better way!
"""
...
class GeneratorToW(nn.Module):
    ...
    def __call__(self, z, c=None, truncation_psi=1, truncation_cutoff=None, skip_w_avg_update=False, train=True, noise_mode='random', rng=random.PRNGKey(0)):
        ...
        # print(f"dlatents_in {dlatents_in}")
        # print(dlatents_in.shape)
        return dlatents_in
...
class GeneratorFromW(nn.Module):
    """
    Generator.
    ...
    @nn.compact
    def __call__(self, dlatents_in, c=None, truncation_psi=1, truncation_cutoff=None, skip_w_avg_update=False, train=True, noise_mode='random', rng=random.PRNGKey(0)):
        """
        Run Generator.
